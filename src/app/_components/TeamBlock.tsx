...
import { NativeMagnetic } from "@/components/uitripled/native-magnetic-shadcnui";
import { appInfo } from "@/config/ConfigData";
import { Variants, useMotionValue, useReducedMotion, useSpring, useTransform, motion } from "framer-motion";
import { Sparkles, MapPin, Github, Mail } from "lucide-react";
...
function TeamMemberCard({ member }: { member: (typeof appInfo.teamMembers)[0] }) {
  ...
  return (
    <motion.div variants={itemVariants} className="perspective-1000">
      ...
      >
        <Card className="relative h-full overflow-hidden rounded-3xl border border-border/60 bg-card  backdrop-blur-xl transition-shadow duration-500">
          ...
          <div className="relative z-10 p-6">
            ...
            <div className="text-center">
              <motion.h3
                className="mb-1 text-xl font-semibold tracking-tight text-f text-foreground"
              ...
              <p className="w-[90%] mx-auto mb-4 text-sm text-[var(--muted-foreground)]">
                {member.bio}
              </p>
              ...
              >
                {[
                ...
                ].filter(item => Object.keys(member.social || {}).includes(item.label)).map((social, idx) => (
                  <motion.div
                    key={social.label}
                  ...
                  >
                    ...
                    >
                      <Link target="_blank" href={member.social![social.label as keyof typeof member.social]}>
                        <motion.div
                          transition={{
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <motion.h2
            ...
            className="mb-6 bg-gradient-to-r from-black via-black/80 to-black/60 dark:from-white dark:via-white/80 dark:to-white/60 bg-clip-text text-5xl font-semibold tracking-tight text-transparent md:text-6xl"
            ...
            <NativeMagnetic>
              ...
              >
                <Link href={`${appInfo.email.href}`}>
                  ...
                  />
                  <span className="relative font-medium">邮件联系</span>
                  <motion.span
