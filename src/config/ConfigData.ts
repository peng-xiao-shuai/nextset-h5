...
export const appInfo = {
  ...
  features: [
    {
      icon: BadgeCheck,
      title: '完全免费',
      description: '所有功能无付费门槛，不订阅、不内购，专注训练本身。',
    },
    {
      icon: Zap,
      title: '轻量且流畅',
      description: '鸿蒙原生开发，启动快、操作顺，不做臃肿功能堆砌。',
    },
    {
      icon: Target,
      title: '专注训练记录',
  ...
  initialTasks: [
    ...
    // },
    {
      id: '6.3.1',
      columnId: 'done',
      content: 'Release v2.3.1',
      priority: 'high',
      tags: ['发布'],
      link: './feature-preview?version=2.3.1',
      // comments: 12,
      // attachments: 4,
      dueDate: '2026/08/07',
    },
    {
      id: '6.3',
      columnId: 'done',
      content: 'Release v2.3.0',
      priority: 'high',
      tags: ['发布'],
      link: './feature-preview?version=2.3.0',
      // comments: 12,
      // attachments: 4,
      dueDate: '2026/06/17',
    },
    {
      id: '6.2',
      columnId: 'done',
      content: 'Release v2.2.0',
      priority: 'high',
      tags: ['发布'],
      link: './feature-preview?version=2.2.0',
      // comments: 12,
      // attachments: 4,
      dueDate: '2026/05/14',
    },
    {
      ...
      priority: 'high',
      tags: ['发布'],
      link: './feature-preview?version=2.1.0',
      // comments: 12,
      // attachments: 4,
      dueDate: '2026/03/30',
    },
    {
      ...
      priority: 'high',
      tags: ['发布'],
      link: './feature-preview?version=2.0.0',
      // comments: 12,
      // attachments: 4,
      dueDate: '2026/01/08',
    },
  ...
  services: [
    ...
    },
    {
      icon: BarChart3,
      title: '数据分析',
      description: '用数据看见你的成长，训练进步一目了然。',
      badge: '新功能',
    },
    {
      icon: Timer,
    ...
    },
    {
      icon: Users,
      title: '训练搭子',
      description: '找到你的训练搭子，坚持不再孤单。',
      badge: null,
    },
    {
      icon: Rocket,
      title: '极简体验',
      description: '无广告、无付费门槛，打开即用，专注于记录与数据。',
      badge: null,
    },
    {
      icon: Calculator,
  ...
  faqs: [
    {
      question: '动作容量增幅是如何计算的？',
      answer:
        '容量增幅是根据该动作最后一次完成的完成容量（例如；3月10日，3月11日训练都训练了某一个动作，在3月12日训练时读取3月11日该动作完成容量。但是在3月12日训练前更改了3月10日该动作的训练容量后，再次创建训练记录，将会读取3月10日该动作完成容量）和当前动作容量计算得出。（注: 动作首次训练容量增幅为 0.00% ）',
    },
    {
      question: '为什么没有 RPE 标记？',
      answer:
        '也曾设想过在 UI 中添加 RPE 标记，经过讨论发现需要用户主动去标记会增加用户操作。故此将主动 RPE 标记改为算法计算标记，根据历史训练以及体重计算得出 RPE。（注: 没有补充体重数据以及动作首次开始训练是没有 RPE 标记的）',
    },
    {
      question: 'APP是否会支持安卓和苹果？',
      answer: '后续会进行开发安卓版本，但是ios版本会视情况而定',
    },
  ],
